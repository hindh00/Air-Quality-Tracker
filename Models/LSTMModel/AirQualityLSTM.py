...
# ==================== DATA LOADING ====================
print("Loading data...")
df = pd.read_csv('../../Data/final_training_data_all_regions.csv', parse_dates=['time'])
...
consolidated_path = os.path.join(MODEL_DIR, 'lstm_model.pkl')
...
print("\n" + "="*50)
print("FILES SAVED IN 'LSTM_output' DIRECTORY")
print("="*50)
print(f"1. lstm_model.pkl - Consolidated file with all artifacts")
...
with open('LSTM_model/lstm_model.pkl', 'rb') as f:
